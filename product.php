...
<body>
                    ...
                    <?php if (isLoggedIn()): ?>
                        <div class="user-profile-container" style="position: relative;">
                            <div class="user-profile" id="userProfile" onclick="toggleDropdown()">
                                ...
                                <div class="user-info">
                                    <strong><?php echo isset($_SESSION['username']) ? $_SESSION['username'] : 'User'; ?></strong>
                                    <br>
                                    <small><?php echo isset($_SESSION['full_name']) ? $_SESSION['full_name'] : 'Member'; ?></small>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Add to cart functionality for product.php
            ...
            // Handle "Login to Purchase" links
