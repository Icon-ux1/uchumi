    ...
    <div class="announcement-bar">
        <div class="container">
            <div class="announcement-text">
                ...
                <span class="offer-tag">CRAZY OFFERS</span>
            </div>
            <div class="announcement-text">
                <i class="fas fa-phone"></i>
                <span>Call us: 0769598625</span>
            </div>
        </div>
    </div>
                ...
                <div class="header-actions">
                    ...
                    <?php if (isLoggedIn()): ?>
                        <div class="user-profile-container" style="position: relative;">
                            ...
                            <div id="userDropdown" class="dropdown-menu" style="display: none; position: absolute; top: 100%; right: 0; background: white; box-shadow: 0 5px 15px rgba(0,0,0,0.1); border-radius: 10px; padding: 10px; min-width: 180px; z-index: 1001; margin-top: 10px;">
                                <a href="profile.php" style="display: block; padding: 10px; text-decoration: none; color: #333; border-bottom: 1px solid #eee;"><i class="fas fa-user-circle" style="margin-right: 10px;"></i> My Profile</a>
                                <a href="orders.php" style="display: block; padding: 10px; text-decoration: none; color: #333; border-bottom: 1px solid #eee;"><i class="fas fa-shopping-bag" style="margin-right: 10px;"></i> My Orders</a>
                                <?php if (isAdmin()): ?>
                                    <a href="admin/index.php" style="display: block; padding: 10px; text-decoration: none; color: #2e7d32; font-weight: 600; border-bottom: 1px solid #eee;"><i class="fas fa-user-shield" style="margin-right: 10px;"></i> Admin Panel</a>
                                <?php endif; ?>
                                <a href="logout.php" style="display: block; padding: 10px; text-decoration: none; color: #e53935;"><i class="fas fa-sign-out-alt" style="margin-right: 10px;"></i> Logout</a>
                            </div>
                        </div>
                        <script>
                    ...
                    <?php foreach($featured_products as $product): ?>
                        ...
                        <div class="product-card" data-category="<?php echo strtolower($product['category'] ?? 'vegetables'); ?>">
                            ...
                            <div class="product-image">
                                <img src="<?php echo $product['image_url'] ?? 'images/placeholders/product-placeholder.jpg'; ?>" 
                                     alt="<?php echo htmlspecialchars($product['name']); ?>"
                                     onerror="this.src='images/placeholders/product-placeholder.jpg'">
            ...
            <div class="categories-grid">
                <div class="category-card">
                    <div class="category-image">
                        <img src="images/categories/vegetables-category.jpg" alt="Vegetables" onerror="this.src='images/placeholders/category-placeholder.jpg'">
                    </div>
                ...
                <div class="category-card">
                    <div class="category-image">
                        <img src="images/categories/fruits-category.jpg" alt="Fruits" onerror="this.src='images/placeholders/category-placeholder.jpg'">
                    </div>
                    <div class="category-content">
                        <div class="category-icon">
                ...
                <div class="category-card">
                    <div class="category-image">
                        <img src="images/categories/dairy-category.jpg" alt="Dairy" onerror="this.src='images/placeholders/category-placeholder.jpg'">
                    </div>
                    <div class="category-content">
                        <div class="category-icon">
                ...
                <div class="category-card">
                    <div class="category-image">
                        <img src="images/categories/groceries-category.jpg" alt="Groceries" onerror="this.src='images/placeholders/category-placeholder.jpg'">
                    </div>
                    <div class="category-content">
                        <div class="category-icon">
            ...
            <div class="footer-grid">
                <div class="footer-col">
                    ...
                    <div class="social-links">
                        ...
                        <a href="whatsapp.com"><i class="fab fa-whatsapp"></i></a>
                    </div>
                </div>
                ...
                <div class="footer-col">
                    ...
                    <ul class="contact-info">
                        ...
                        <li>
                            <i class="fas fa-phone"></i>
                            <span>0769598625<br>0101879368</span>
                        </li>
                        <li>
